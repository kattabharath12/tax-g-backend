...
-- CreateIndex
CREATE INDEX "DeductionEntry_taxReturnId_idx" ON "DeductionEntry"("taxReturnId");

-- CreateIndex
CREATE INDEX "Dependent_taxReturnId_idx" ON "Dependent"("taxReturnId");
...
-- CreateIndex
CREATE INDEX "DocumentExtractedEntry_documentId_idx" ON "DocumentExtractedEntry"("documentId");
...
-- AddForeignKey
ALTER TABLE "DocumentExtractedEntry" ADD CONSTRAINT "DocumentExtractedEntry_incomeEntryId_fkey" FOREIGN KEY ("incomeEntryId") REFERENCES "IncomeEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DocumentExtractedEntry" ADD CONSTRAINT "DocumentExtractedEntry_deductionEntryId_fkey" FOREIGN KEY ("deductionEntryId") REFERENCES "DeductionEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
